/**
 * Footer Komponente
 * Mit Links, Social Media und Copyright
 */
            ...
            <div className="flex space-x-3 mt-4">
              {FOOTER.social.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-slate-800 hover:bg-slate-700 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-200"
